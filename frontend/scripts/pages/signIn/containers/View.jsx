...
class AuthorizationView extends Component {
  onAuthorisationUser = (values) => {
    const { authorization: { authorisationUser } } = this.props;
    authorisationUser(values);
  };
            ...
            <div className="sign-in-form">
              ...
              <main className="sign-in-form__main">
                <Form
                  error={error}
                  status={status}
                  onSubmit={this.onAuthorisationUser}
                  validate={validation}
                />
              </main>
...
AuthorizationView.propTypes = {
  authorization: PropTypes.objectOf(
    PropTypes.shape({
      authorisationUser: PropTypes.func.isRequired,
