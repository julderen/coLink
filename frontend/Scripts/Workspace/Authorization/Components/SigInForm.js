...
const SignInForm = (_a) => {
    ...
    <Form_1.Input name="password" label="Password" type="password" icon="lock" maxLength={SignInConstants_1.FIELD_MAX_LENGTH}/>
    <Controls_1.ButtonsGroup>
      <Controls_1.ButtonLoader status={status}>sign in</Controls_1.ButtonLoader>
    </Controls_1.ButtonsGroup>
  </Form_1.Form>);
};
