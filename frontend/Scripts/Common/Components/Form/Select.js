...
const FormSearcher = (_a) => {
    ...
    return (<redux_form_1.Field name={name} props={Object.assign({}, props, { label, placeholder: FormUtils_1.default.definePlaceholderField(label, placeholder) })} component={Controls_1.Searcher}/>);
};
